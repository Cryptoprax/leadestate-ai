...
test("workforce roles explain real estate outcomes and daily work", () => {
  const source = read("features/marketing/components/EnterpriseExperience.tsx");
  for (const employee of ["AI Sales Assistant", "AI CRM Manager", "AI Marketing Strategist", "AI WhatsApp Assistant", "AI Voice Agent", "AI Property Advisor", "AI Operations Manager", "AI Executive Assistant"]) assert.match(source, new RegExp(employee));
