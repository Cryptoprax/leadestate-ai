...
export type MarketingEventType = "page_view" | "cta_click" | "demo_request" | "trial_signup" | "contact_sales" | "newsletter" | "demo_launch" | "roi_calculation" | "industry_view" | "comparison_view" | "marketing_conversion";
