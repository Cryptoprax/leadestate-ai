...
export const shellNavigation: readonly ShellNavigationGroup[] = [
  ...
  },
  {
    ...
    icon: Megaphone,
    items: [
      { label: "Growth Hub", href: "/vayon/growth", icon: Megaphone },
      { label: "Campaigns", href: "/vayon/growth", icon: BriefcaseBusiness },
      {
        label: "Landing Pages",
        icon: LayoutTemplate,
        disabled: true,
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Calls", href: "/vayon/communications", icon: Phone },
    ],
  },
  {
    id: "ai",
