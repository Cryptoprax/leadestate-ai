...
export const leadEstateNavigation: readonly NavigationItem[] = [
  ...
  { id: "leadestate-billing", label: "Billing", href: "/leadestate/settings/billing", icon: "B", surface: "sidebar", order: 9, visible: true, permission: { anyOf: ["organizations.manage", "users.manage"] } },
  { id: "leadestate-team", label: "Team", href: "/leadestate/team", icon: "T", surface: "sidebar", order: 10, visible: true, permission: { anyOf: ["users.read", "users.manage"] } },
];
