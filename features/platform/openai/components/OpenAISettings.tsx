...
export async function OpenAISettings() {
  ...
  return <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
    <header className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-semibold uppercase tracking-[.18em] text-vds-primary">AI Workforce · Provider</p><h1 className="mt-1 text-3xl font-semibold">OpenAI settings</h1><p className="mt-2 max-w-2xl text-sm text-vds-muted">Live OpenAI with governed deterministic failure fallback.</p></div><ButtonLink href="/vayon/ai/workforce" variant="outline">AI Workforce</ButtonLink></header>
    ...
    <section className="mt-5 rounded-2xl border border-vds-border bg-vds-surface p-6"><h2 className="text-xl font-semibold">Safety and governance</h2><p className="mt-2 text-sm text-vds-muted">Prompts require workspace attribution, pass validation and moderation, and are not logged. Outputs remain recommendation-only and require Workflow Approval.</p></section>
  </main>;
}
