...
export type OpenAIHealthDiagnostic="connected"|"missing_api_key"|"invalid_api_key"|"authentication_failed"|"billing_required"|"insufficient_quota"|"model_unavailable"|"network_error"|"timeout"|"provider_exception";
