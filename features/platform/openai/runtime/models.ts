...
export interface WorkforceMessage { readonly id: string; readonly conversationId: string; readonly role: "user" | "assistant"; readonly content: string; readonly model: string | null; readonly usage: TokenUsage | null; readonly cost: CostEstimate | null; readonly latencyMs: number | null; readonly createdAt: string; readonly recommendationOnly: true; }
