...
const nodes: readonly NodeRegistration[] = [
  ["trigger","Trigger","control"],["condition","Condition","control"],["delay","Delay / wait","control"],["approval","Approval","control"],["branch","Branch","control"],["loop","Loop","control"],["end","End","control"],
