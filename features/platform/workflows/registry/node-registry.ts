...
const nodes: readonly NodeRegistration[] = [
  ["trigger","Trigger","control"],["condition","Condition","control"],["delay","Delay","control"],["approval","Approval","control"],["branch","Branch","control"],["loop","Loop","control"],
  ...
  ["variable","Variable","data"],["math","Math","data"],["formatter","Formatter","data"],["ai","AI placeholder","intelligence"],["plugin","Future plugin","extension"],
