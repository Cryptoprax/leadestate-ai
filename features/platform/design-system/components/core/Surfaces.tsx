...
export function Card({ className = "", children, ...props }: SurfaceProps) { return <article className={`vds-surface vds-card-motion rounded-2xl p-5 sm:p-6 ${className}`} {...props}>{children}</article> }
